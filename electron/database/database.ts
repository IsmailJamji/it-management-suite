...
export class Database {
  ...
  public isDatabaseInitialized(dbPath?: string): boolean {
    try {
      const target = dbPath ?? this.configService.getDatabasePath();
      ...
      const probe = new BetterSqlite3(target, { readonly: true });
