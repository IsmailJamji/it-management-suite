  ...
  excelImport: {
    ...
    execute: (fileData: string, type: string) => Promise<any>;
      ...
      system: {
        ...
        getLiveMetrics: () => Promise<{ cpu: number; memory: number; disk: number }>;
      ...
      installation: {
        ...
        setDatabasePath: (newPath: string) => Promise<{ success: boolean; dbPath?: string; message?: string }>;
        ...
        createSyncFolder: (type: 'onedrive' | 'googledrive') => Promise<{
          success: boolean;
          dbPath?: string;
          folderPath?: string;
          message?: string;
